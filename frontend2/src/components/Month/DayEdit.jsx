...
export default function DayEdit() {
    ...
    return (
        ...
        <TableBody>
            <TableRow row="Date" sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                <TableCell component="th" scope="row">Date</TableCell>
                <TableCell>{data.Date}</TableCell>
            </TableRow>

            <TableRow row="Comment" sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                <TableCell component="th" scope="row">Comment</TableCell>
                <TableCell>
                    <TextField id="comment" label="Comment" defaultValue={data.Comment} name="comment" fullWidth/> 
                </TableCell>
            </TableRow>

            <TableRow row="Tags" sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                <TableCell component="th" scope="row">Comment</TableCell>
                <TableCell>
                    <TextField id="tags" label="tags" defaultValue={Tag(data.Tags)} name="tags" fullWidth/> 
                </TableCell>
            </TableRow>
