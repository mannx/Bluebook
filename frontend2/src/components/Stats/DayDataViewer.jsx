...
export default function DayDataViewer() {
    ...
    <Form>
        ...
        <Select labelId="year" name="minYear" defaultValue={years[years.length-1]} value={minYear} onChange={(e) => setMinYear(e.target.value)}>
        {years.map((n) => {
            return (
        ...
        <Select labelId="year" name="maxYear" defaultValue={years[years.length-1]} value={maxYear} onChange={(e) => setMaxYear(e.target.value)}>
        {years.map((n) => {
            return (
            <MenuItem key={n} value={n}>
                {n}
        ...
        <Link to={`/ddviewer/${minYear}/${maxYear}`}>
